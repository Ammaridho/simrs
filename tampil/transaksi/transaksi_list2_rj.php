...
<td><?php
    ...
    $qry4 = mysqli_query($koneksi,$sql4) or die ("Query error :" . mysqli_error($koneksi));
...
<td><div align="center">
<?php
if($data2['status']=="Selesai" OR $data3['status_tm']=="Selesai"){ 
echo "<a href='transaksi_tindakan.php?kd_kunjungan=".$data['kd_kunjungan']."'>Proses Billing </a>";
}
else { 
echo "Finish";
}
