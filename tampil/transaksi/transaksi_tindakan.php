...
<input type="hidden" name="username" size="4" value="<?php echo $_SESSION['username'];?>">
...
?>
  ...
  <tr bgcolor="#FFFFFF">
<td colspan="6" align="left" bgcolor="#FFFFFF"><input type="hidden" name="jumMK" value="<?php echo $i-1; ?>" />
