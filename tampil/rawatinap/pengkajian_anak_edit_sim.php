<title>PENGKAJIAN AWAL ANAK DAN REMAJA</title>
<?php 
...
status			= 	'Inprogress'
	...
	mysqli_query($koneksi, $sql) 
		  or die ("Maaf, data belum berhasil di-update !".mysqli_error($koneksi));
...
<?php 
	...
	$no++;
  ?>
<meta http-equiv="refresh" content="1;url=pengkajian_anak_edit.php?kd_kunjungan=<?php echo $data['kd_kunjungan'];?>" />
<?php
}
?>
