...
if (trim($kaji_awal94	)=="") {	$pesan[] = "	Abdomen	belum diisi	!";	}
if (trim($kaji_awal72	)=="") {	$pesan[] = "	Adanya batuk	belum diisi	!";	}
if (trim($kaji_awal73	)=="") {	$pesan[] = "	Adanya lendir	belum diisi	!";	}
if (trim($kaji_awal85	)=="") {	$pesan[] = "	Akral ekstremitas bawah	belum diisi	!";	}
if (trim($kaji_awal84	)=="") {	$pesan[] = "	Akral kstremitas atas	belum diisi	!";	}
if (trim($kaji_awal06	)=="") {	$pesan[] = "	Alasan masuk rawat	belum diisi	!";	}
if (trim($kaji_awal108	)=="") {	$pesan[] = "	Alat bantu kateter	belum diisi	!";	}
if (trim($kaji_awal02	)=="") {	$pesan[] = "	Alat transfort menggunakan	belum diisi	!";	}
if (trim($kaji_awal50	)=="") {	$pesan[] = "	APGAR Score	belum diisi	!";	}
if (trim($kaji_awal07	)=="") {	$pesan[] = "	Berat badan	belum diisi	!";	}
if (trim($kaji_awal31	)=="") {	$pesan[] = "	Berat badan lahir	belum diisi	!";	}
if (trim($kaji_awal97	)=="") {	$pesan[] = "	Bising usus	belum diisi	!";	}
if (trim($kaji_awal100	)=="") {	$pesan[] = "	Buang air besar	belum diisi	!";	}
if (trim($kaji_awal80	)=="") {	$pesan[] = "	Bunyi jantung	belum diisi	!";	}
if (trim($kaji_awal101	)=="") {	$pesan[] = "	Cara buang air besar	belum diisi	!";	}
if (trim($kaji_awal140	)=="") {	$pesan[] = "	Diagnosa medis saat masuk	belum diisi	!";	}
if (trim($pengantar	)=="") {	$pesan[] = "	Diantar oleh...	belum diisi	!";	}
if (trim($kaji_awal81	)=="") {	$pesan[] = "	Frekwensi nadi	belum diisi	!";	}
if (trim($kaji_awal68	)=="") {	$pesan[] = "	Frekwensi napas	belum diisi	!";	}
if (trim($kaji_awal123	)=="") {	$pesan[] = "	Gerakan	belum diisi	!";	}
if (trim($kaji_awal16	)=="") {	$pesan[] = "	Golongan darah ayah	belum diisi	!";	}
if (trim($kaji_awal17	)=="") {	$pesan[] = "	Golongan darah ibu	belum diisi	!";	}
if (trim($kaji_awal53	)=="") {	$pesan[] = "	Imunisasi yang diberikan	belum diisi	!";	}
if (trim($kaji_awal139	)=="") {	$pesan[] = "	Informasi yang didapat	belum diisi	!";	}
if (trim($kaji_awal128	)=="") {	$pesan[] = "	Integritas kulit	belum diisi	!";	}
if (trim($kaji_awal69	)=="") {	$pesan[] = "	Irama napas	belum diisi	!";	}
if (trim($kaji_awal138	)=="") {	$pesan[] = "	Jam lahir	belum diisi	!";	}
if (trim($kaji_awal03	)=="") {	$pesan[] = "	Jam masuk	belum diisi	!";	}
if (trim($kaji_awal127	)=="") {	$pesan[] = "	Kebersihan	belum diisi	!";	}
if (trim($kaji_awal124	)=="") {	$pesan[] = "	Kejang	belum diisi	!";	}
if (trim($kaji_awal95	)=="") {	$pesan[] = "	Kelainan abdomen	belum diisi	!";	}
if (trim($kaji_awal93	)=="") {	$pesan[] = "	Kelainan rongga mulut	belum diisi	!";	}
if (trim($kaji_awal117	)=="") {	$pesan[] = "	Kepala	belum diisi	!";	}
if (trim($kaji_awal111	)=="") {	$pesan[] = "	Kesadaran	belum diisi	!";	}
if (trim($kaji_awal05	)=="") {	$pesan[] = "	Kondisi saat masuk	belum diisi	!";	}
if (trim($kaji_awal33	)=="") {	$pesan[] = "	Lingkar kepala	belum diisi	!";	}
if (trim($kaji_awal118	)=="") {	$pesan[] = "	Lingkar kepala	belum diisi	!";	}
if (trim($kaji_awal34	)=="") {	$pesan[] = "	Lingkar perut	belum diisi	!";	}
if (trim($kaji_awal99	)=="") {	$pesan[] = "	Masalah pada tali pusat	belum diisi	!";	}
if (trim($kaji_awal01	)=="") {	$pesan[] = "	Masuk melalui...	belum diisi	!";	}
if (trim($kaji_awal76	)=="") {	$pesan[] = "	Memakai oksigen	belum diisi	!";	}
if (trim($kaji_awal92	)=="") {	$pesan[] = "	Mukosa mulut	belum diisi	!";	}
if (trim($kaji_awal10	)=="") {	$pesan[] = "	Nadi	belum diisi	!";	}
if (trim($kaji_awal136	)=="") {	$pesan[] = "	Nama orang tua	belum diisi	!";	}
if (trim($kaji_awal32	)=="") {	$pesan[] = "	Panjang badan lahir	belum diisi	!";	}
if (trim($kaji_awal83	)=="") {	$pesan[] = "	Pengisian kapiler	belum diisi	!";	}
if (trim($kaji_awal26	)=="") {	$pesan[] = "	Penyakit keturunan ayah	belum diisi	!";	}
if (trim($kaji_awal27	)=="") {	$pesan[] = "	Penyakit keturunan ibu	belum diisi	!";	}
if (trim($kaji_awal11	)=="") {	$pesan[] = "	Pernapasan	belum diisi	!";	}
if (trim($kaji_awal67	)=="") {	$pesan[] = "	Pernapasan	belum diisi	!";	}
if (trim($kaji_awal49	)=="") {	$pesan[] = "	Persalinan	belum diisi	!";	}
if (trim($kaji_awal86	)=="") {	$pesan[] = "	Puasa	belum diisi	!";	}
if (trim($kaji_awal120	)=="") {	$pesan[] = "	Pupil	belum diisi	!";	}
if (trim($kaji_awal121	)=="") {	$pesan[] = "	Reaksi cahaya pupil kanan	belum diisi	!";	}
if (trim($kaji_awal122	)=="") {	$pesan[] = "	Reaksi cahaya pupil kiri	belum diisi	!";	}
if (trim($kaji_awal18	)=="") {	$pesan[] = "	Riwayat alergi ayah	belum diisi	!";	}
if (trim($kaji_awal19	)=="") {	$pesan[] = "	Riwayat alergi ibu	belum diisi	!";	}
if (trim($kaji_awal79	)=="") {	$pesan[] = "	Riwayat aspirasi	belum diisi	!";	}
if (trim($kaji_awal13	)=="") {	$pesan[] = "	Riwayat kesehatan	belum diisi	!";	}
if (trim($kaji_awal12	)=="") {	$pesan[] = "	Saturasi	belum diisi	!";	}
if (trim($kaji_awal129	)=="") {	$pesan[] = "	Sekret mata	belum diisi	!";	}
if (trim($kaji_awal70	)=="") {	$pesan[] = "	Suara napas	belum diisi	!";	}
if (trim($kaji_awal09	)=="") {	$pesan[] = "	Suhu	belum diisi	!";	}
if (trim($kaji_awal98	)=="") {	$pesan[] = "	Tali pusat	belum diisi	!";	}
if (trim($kaji_awal137	)=="") {	$pesan[] = "	Tanggal lahir	belum diisi	!";	}
if (trim($kaji_awal116	)=="") {	$pesan[] = "	Tangisan	belum diisi	!";	}
if (trim($kaji_awal82	)=="") {	$pesan[] = "	Tekanan darah	belum diisi	!";	}
if (trim($kaji_awal52	)=="") {	$pesan[] = "	Tetes mata	belum diisi	!";	}
if (trim($kaji_awal08	)=="") {	$pesan[] = "	Tinggi badan	belum diisi	!";	}
if (trim($kaji_awal126	)=="") {	$pesan[] = "	Turgor kulit	belum diisi	!";	}
if (trim($kaji_awal119	)=="") {	$pesan[] = "	Ubun-ubun	belum diisi	!";	}
if (trim($kaji_awal30	)=="") {	$pesan[] = "	Usia kehamilan	belum diisi	!";	}
if (trim($kaji_awal51	)=="") {	$pesan[] = "	Vitamin K	belum diisi	!";	}
if (trim($kaji_awal125	)=="") {	$pesan[] = "	Warna kulit	belum diisi	!";	}
if (! count($pesan)==0) {
