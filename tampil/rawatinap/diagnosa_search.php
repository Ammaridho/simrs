...
<body id=tab1>
  <table align="left" width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#CCCCCC">
      <tr bgcolor="#FFFFFF">
      <td width="4%" align="center" bgcolor="#D9E8F3"><b>Cek</b></td>
      <td width="2%" align="center" bgcolor="#D9E8F3"><b>P</b></td>
      <td width="61%" align="center" bgcolor="#D9E8F3"><b>Diagnosa Keperawatan</b></td>
      <td width="33%" align="left" bgcolor="#D9E8F3"><b>Faktor yang berhubungan</b></td>
   	</tr>
  <form name="form1" method="post" action="diagnosasim.php?kd_kunjungan=<?php echo $kd_kunjungan;?>">
...
<?php
$q = $_REQUEST['q'];
$query = "SELECT * FROM diagnosadb WHERE nama_diagnosa LIKE '%".$q."%'";
$hasil = mysqli_query($koneksi,$query);
$no = 1;
while ($data = mysqli_fetch_array($hasil))
{
?>
      <td width="4%" align="center" bgcolor="#FFFFFF"><input type="checkbox" value="<?php echo $data['nama_diagnosa'];?>" name="dx<?php echo $no;?>" /></td>
      <td width="2%" align="left" bgcolor="#FFFFFF"><input type="text" name="prioritas<?php echo $no;?>" size="1"></td>
      <td width="61%" align="left" bgcolor="#FFFFFF"><?php echo $data['nama_diagnosa'];?></td>
      <td width="33%" align="left" bgcolor="#FFFFFF"><select name="bd<?php echo $no;?>">
...
?>
    <tr bgcolor="#FFFFFF">
      <td width="4%" bgcolor="#FFFFFF"><input type="hidden" name="jumMK" value="<?php echo $no-1; ?>" /></td>
      <td colspan="2" bgcolor="#FFFFFF"><input type="submit" name="Submit" value="Tambahkan"></td>
<td width="33%">&nbsp;</td>
    </tr>
	  </form>
	  <script>
