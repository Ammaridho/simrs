...
$sql = "SELECT * FROM handover WHERE kd_ho='$kd_ho' AND kd_kunjungan='$kd_kunjungan'";
...
<form name="form1" method="post" action="handover_edit_sim.php?kd_kunjungan=<?php echo $data['kd_kunjungan'];?>">
<input name="kd_ho" type="hidden" value="<?php echo $data['kd_ho'];?>"/>
<input name="kd_kunjungan" type="hidden" value="<?php echo $data['kd_kunjungan'];?>"/>
    <tr onMouseOver="this.bgColor='lightyellow'" onMouseOut="this.bgColor='#ffffff'" bgcolor="#ffffff">
      <td>Tanggal / Jam</td>
      <td><input name="tgl_ho" type="text" id="tgl_ho" size="10" value="<?php echo $data['tgl_ho'];?>"> / <input name="jam_ho" type="text" id="jam_ho" size="10" value="<?php echo $data['jam_ho'];?>"> WIB</td>
    </tr>
    <tr onMouseOver="this.bgColor='lightyellow'" onMouseOut="this.bgColor='#ffffff'" bgcolor="#ffffff">
      <td>Shift</td>
...
<?php echo $data['handover'];?></textarea>
	<script type="text/javascript">
		//<![CDATA[
