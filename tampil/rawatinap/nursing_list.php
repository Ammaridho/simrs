...
$hari = $data_u['selisih'] - $bulan * 30 - $tahun * 365;
  ...
  ?>
	...
	<td><?php echo $no++ ;?> </td>
      <td><a href="header.php?kd_kunjungan=<?php echo $data['kd_kunjungan']; ?>"><?php echo $data['nama'];?> [<?php echo $data['prn'];?>]</a></td>
      <td><a href="header.php?kd_kunjungan=<?php echo $data['kd_kunjungan']; ?>"><?php echo $data['tgl_lahir'];?></br> [<?php echo "$tahun";?> thn,<?php echo "$bulan";?> bln]</a></td>
      <td><a href="header.php?kd_kunjungan=<?php echo $data['kd_kunjungan']; ?>"><?php echo $data['tanggal'];?></a></td>
      <td><a href="header.php?kd_kunjungan=<?php echo $data['kd_kunjungan']; ?>"><?php echo $data['kamar'];?>/<?php echo $data['kelas'];?></a></td>      
<td><a href="header.php?kd_kunjungan=<?php echo $data['kd_kunjungan']; ?>"><?php echo $data['diagnosa_masuk'];?></a></td>
