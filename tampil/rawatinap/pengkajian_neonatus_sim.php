...
status
	...
	$sql .=	" VALUES ('$kd_kunjungan','$tanggal','$jam','$shift','$nik','Pengkajian Neonatus','$pengantar',
'$kaji_awal01',
'$kaji_awal02',
'$kaji_awal03',
'$kaji_awal04',
...
'Inprogress')";
	mysqli_query($koneksi, $sql) 
		  or die ("Maaf! Data pengkajian tidak tersimpan!".mysqli_error($koneksi));
...
<?php 
	...
	$no++;
  ?>
<meta http-equiv="refresh" content="1;url=pengkajian_neonatus_edit.php?kd_kunjungan=<?php echo $data['kd_kunjungan'];?>" />
<?php
}
?>
