...
<form name="form1" action="pengkajian_neonatus_edit_sim.php" method="POST"  onSubmit="return validasi()">
...
<tr bgcolor="#D9E8F3">
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td>:</td>
    <td colspan="2"><input name="kaji_awal137" id="kaji_awal137" type="text" value="<?php echo $data['kaji_awal137'] ;?>"/>
      <input name="kaji_awal138" id="kaji_awal138" type="text" value="<?php echo $data['kaji_awal138'] ;?>"/></td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td>Informasi didapat dari </td>
    <td>:</td>
    <td colspan="2"><input name="kaji_awal139" id="kaji_awal139" type="text" value="<?php echo $data['kaji_awal139'] ;?>"/></td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td>Diagnosa Medis saat masuk </td>
    <td>:</td>
    <td colspan="2"><input name="kaji_awal140" id="kaji_awal140" type="text" value="<?php echo $data['kaji_awal140'] ;?>"/></td>
  </tr>
  <tr bgcolor="#D9E8F3">
  ...
  <tr onMouseOver="this.bgColor='lightblue'" onMouseOut="this.bgColor='#ffffff'" bgcolor="#ffffff">
    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Riwayat kesehatan, Pernah dirawat ?   </td>
    <td>:</td>
    <td colspan="2"><input name="kaji_awal13" type="text" value="<?php echo $data['kaji_awal13'] ;?>"/></td>
  </tr>
  <tr onMouseOver="this.bgColor='lightblue'" onMouseOut="this.bgColor='#ffffff'" bgcolor="#ffffff">
    <td>&nbsp;&nbsp;    8. Kapan/lama perawatan (*diisi jika pernah dirawat) </td>
    <td>:</td>
...
Ya</td>
  ...
  <tr onMouseOver="this.bgColor='lightblue'" onMouseOut="this.bgColor='#ffffff'" bgcolor="#ffffff">
	...
	?>
      ...
      Forcep
      <input name="kaji_awal49" type="radio" value="SC" <?php echo $cek_4;?>/>
      SC</td>
  </tr>
  <tr onMouseOver="this.bgColor='lightblue'" onMouseOut="this.bgColor='#ffffff'" bgcolor="#ffffff">
    <td>&nbsp;&nbsp;    7. APGAR Score </td>
...
Spontan
<input name="kaji_awal101" type="radio" value="Dirangsang" <?php echo $cek_2;?>/>Dirangsang 
...
function calc(){
one = document.form1.kaji_awal132.value;
document.form1.kaji_awal133.value = one;
}
function stopCalc(){
clearInterval(interval);
}
  ...
  <tr onMouseOver="this.bgColor='lightblue'" onMouseOut="this.bgColor='#ffffff'" bgcolor="#ffffff">
	...
	?>
      <input name="kaji_awal132" type="radio" value="Normal" onFocus="startCalc();" onBlur="stopCalc();" <?php echo $cek_1;?>/>
Normal
<input name="kaji_awal132" type="radio" value="Ada kelainan" onFocus="startCalc();" onBlur="stopCalc();" <?php echo $cek_2;?>/> 
...
Testis belum turun</td>
  ...
  <tr bgcolor="#D9E8F3">
    <td colspan="4">&nbsp;&nbsp;
      ...
      <input type="submit" name="submit" value="END SESSION" onclick="form1.action='pengkajian_neonatus_selesai.php?kd_kunjungan=<?php echo $data['kd_kunjungan'];?>'; return true;" /></td>
    </tr>
  </form>
</table>
</body>
