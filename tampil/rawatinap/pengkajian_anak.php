...
<form name="form1" action="pengkajian_anak_sim.php" method="POST"  onSubmit="return validasi()">
...
Forcep
<input name="kaji_awal157" type="radio" value="SC" <?php echo $cek_3;?>/>
SC</td>
  </tr>
  <tr bgcolor="#FFFFFF">
