...
$q=$_REQUEST['q'];
$query = "SELECT * FROM lab_db,reg WHERE reg.kd_kunjungan='$kd_kunjungan' AND nama_lab LIKE '%$q%' limit 50";
...
?>
    ...
    <td width="53%" align="left" bgcolor="#FFFFFF"><label><input type="text" size="6" value="<?php echo $data['nama_lab'];?>" name="nama_lab<?php echo $i;?>" /></label>
	  <input name="kd_kunjungan" type="text" value="<?php echo $data['kd_kunjungan'];?>"/>
  <input name="tanggal_lab" type="text" value="<?php echo "".date('Y-m-d');?>" />
  <input name="jam_lab" type="text" value="<?php echo "".date('H:i');?>" />
