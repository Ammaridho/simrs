...
?>
	  ...
	  <input type="checkbox" value="<?php echo $data['kd_tm'];?>" name="kd_tm<?php echo $i;?>" /></td>
      	<td align="left" bgcolor="#FFFFFF"><input name="nama_tm<?php echo $i;?>" type="text" value="<?php echo $data['nama_tm'];?>"/>
		  <input type="text" value="<?php echo $_SESSION['klinik'];?>" name="operator" />
          <input name="kd_kunjungan" type="text" value="<?php echo $data['kd_kunjungan'];?>"/>
          <input name="tanggal_tm" type="text" value="<?php echo "".date('Y-m-d');?>" />
          <input name="jam_tm" type="text" value="<?php echo "".date('H:i');?>" />
          <?php echo $data['nama_tm'];?> [<?php echo $data['gol_tm'];?>]</td>
      <td align="left" bgcolor="#FFFFFF"><input type="text" size="6" value="<?php echo $data['harga_tm'];?>" name="harga_tm<?php echo $i;?>" />
      	  <input type="text" size="6" value="<?php echo $data['jasa_tm'];?>" name="jasa_tm<?php echo $i;?>" />
