...
<tr bgcolor="#FFFFFF"> 
  <td>Nama</td>
  <td><input name="nama" type="text" size="20" maxlength="200" value="<?php echo $data['nama'];?>">  </td>
</tr>
<tr bgcolor="#FFFFFF"> 
  ...
  <td width="67%"><select name="kategori" id="kategori">
    ...
    $qry1 = @query($sql1, $koneksi) or die ("gagal Query");
	while ($data1 =fetch_array($qry1)) {
...
<tr bgcolor="#FFFFFF"> 
  ...
  <td align="left"><select name="spesialis" id="spesialis">
    ...
    $qry2 = @query($sql2, $koneksi) or die ("gagal Query");
	while ($data2 =fetch_array($qry2)) {
