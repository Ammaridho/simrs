...
?>
<h3>Nama User : <?php echo $data1['nama'];?></h3>
  <tr>
...
?>
      <input type="checkbox" value="<?php echo $data2['kd_sub_menu'];?>" name="kd_sub_menu<?php echo $i;?>" />
      <input type="hidden" value="<?php echo $data2['kd_menu'];?>" name="kd_menu<?php echo $i;?>" />
      <?php echo $data2['nama_sub_menu'];?>
      <?php $i++;?></br>
      <?php	  
}
?>
...
?>
      <input type="checkbox" value="<?php echo $data3['kd_sub_menu'];?>" name="ksm<?php echo $i;?>" />
      <input type="hidden" value="<?php echo $data3['kd_menu'];?>" name="kd_menu<?php echo $i;?>" />
      <?php echo $data3['nama_sub_menu'];?>
      <?php $i++;?></br>
      <?php	  
}
?></td>
