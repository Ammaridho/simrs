...
<html>
<head>
<title>TAMBAH NIC</title>
</head>
<body>
<form action="nic_sim.php" method="post" name="form1" target="_self">
<table width="100%"  border="0" align="left" cellpadding="3" cellspacing="1" bgcolor="#DBEAF5">
<tr align="left"> 
  <th colspan="2" scope="col">TAMBAH NIC</th>
</tr>
<tr bgcolor="#FFFFFF"> 
  <td width="33%">Kode</td>
  <td width="67%">
	<input name="kd_nic" type="hidden" size="22" maxlength="35" value="<? echo kdauto("nicdb",Nic); ?>">
	<input name="kd_nic" type="text" size="22" maxlength="35" value="<? echo kdauto("nicdb",Nic); ?>" disabled="disabled">
  </td>
</tr>
<tr bgcolor="#FFFFFF"> 
...
<tr bgcolor="#FFFFFF"> 
  <td>NIC</td>
  <td>
<input name="nic" type="text" size="70" maxlength="200" value="<? echo $data['nic']; ?>">
  </td>
</tr>
<tr bgcolor="#FFFFFF"> 
  <td>&nbsp;</td>
