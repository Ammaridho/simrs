...
$kdubah = $_GET['kdubah'];
$sql = "SELECT * FROM ruang WHERE kode_bed='$kdubah'";
...
<tr bgcolor="#FFFFFF"> 
  ...
  <td width="67%">
	<input name="kode_bed" type="hidden" size="22" maxlength="35" value="<?php echo $data['kode_bed']; ?>">
    <input name="kode_bed" type="text" size="22" maxlength="35" value="<?php echo $data['kode_bed']; ?>" disabled="disabled">  </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td>Ruangan</td>
