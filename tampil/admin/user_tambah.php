...
$rsData = mysqli_query($koneksi,$query_rsData) or die(mysqli_error());
...
$query 	= "SELECT * FROM gol_tm ORDER BY kd_gol_tm";
...
$query1 = "SELECT * FROM klinikdb ORDER BY kd_klinik";
$spesialis = mysqli_query($koneksi,$query1);
while($p=mysqli_fetch_array($spesialis)){
...
<tr bgcolor="#FFFFFF"> 
  ...
  <td><input name="tanggal_masuk" type="date" size="20" maxlength="200">  </td>
</tr>
<tr bgcolor="#FFFFFF"> 
  <td>Upload photo</td>
