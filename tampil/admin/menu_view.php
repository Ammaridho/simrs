...
<h3>Nama User : <?php echo $data1['nama_user'];?></h3>
  ...
  <tr bgcolor="#ffffff">
	...
	<input type="hidden" value="<?php echo $data1['username'];?>" name="username" />
      <?php
$sql2 = "SELECT * FROM menu_sub, menu WHERE menu_sub.kd_menu=menu.kd_menu ORDER BY nama_menu, nama_sub_menu";
...
?>
      ...
      <label for="kd_sub_menu<?php echo $i;?>"><?php 
	  echo $data2['nama_menu']; 
	  echo " - ";
	  echo $data2['nama_sub_menu'];?></label>
      <?php $i++;?></br>
      <?php	  
}
?>
    ...
    <td valign="top"><?php
$sql3 = "SELECT * FROM menu_sub,menu_user,menu WHERE menu_sub.kd_menu=menu.kd_menu AND menu_sub.kd_sub_menu=menu_user.kd_sub_menu AND username='$username' ORDER BY nama_menu, nama_sub_menu";
...
?>
	  ...
	  <label for="ksm<?php echo $i;?>">
	  <?php 
	  echo $data3['nama_menu']; 
	  echo " - ";
	  echo $data3['nama_sub_menu'];?></label>
      <?php $i++;?>
      </br>
      <?php	  
}
