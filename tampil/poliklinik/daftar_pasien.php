...
<?php 
//$klinik = $_GET['klinik'];
$query2 ="SELECT * FROM reg,klinikdb WHERE reg.klinik=klinikdb.kd_klinik GROUP BY reg.klinik";
$result2 =mysqli_query($koneksi,$query2) or die(mysqli_connect_error());
$no = 1;
...
<tr onMouseOver="this.bgColor='lightyellow'" onMouseOut="this.bgColor='#ffffff'" bgcolor="#ffffff" span class="style1">
	...
	$sql4 = "SELECT * FROM user WHERE username='$dokter'";
    $qry4 = mysqli_query($koneksi,$sql4) or die ("gagal Query");
	$data4 =mysqli_fetch_array($qry4);?> <?php echo $data4['nama'];?></a></td>
      <td width="12%" bgcolor="#FFFFFF">
