...
if ($adadata >=1) {
   ...
   $kalimat = substr($data['nama_tm'],0,20)
   ?>
   <tr bgcolor="#FFFFFF">
      <td width="5%" bgcolor="#FFFFFF"><div align="center"><?php echo $i;?></div></td>
      <td width="25%" bgcolor="#FFFFFF"><div align="left"><?php echo $data['tanggal_tm'];?></div></td>
      <td width="70%" bgcolor="#FFFFFF"><div align="left"><?php echo $data['nama_tm'];?></div></td>
   </tr>
   <?php
   $i++;
   }
