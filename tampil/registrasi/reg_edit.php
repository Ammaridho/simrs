...
$klinik = mysqli_query("SELECT * FROM klinikdb ORDER BY kd_klinik");
while($p=mysqli_fetch_array($klinik)){
...
?>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td align="left">Nama Petugas</td>
    <td align="left"><select name="dokter" id="dokter">
      <option value="">--Pilih Petugas--</option>
      <?php
//mengambil nama-nama klinik yang ada di database
$dokter = mysqli_query("SELECT * FROM user ORDER BY username");
while($p=mysqli_fetch_array($dokter)){
