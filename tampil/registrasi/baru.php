...
<tr bgcolor="#CCCCCC"> 
  ...
  <tr bgcolor="#FFFFFF">
    <td>PRN *</td>
    <td><input name="prn" type="text" id="prn" maxlength="8" size="10" placeholder="Terisi Otomatis" disabled="disabled">
    </td>
    <td>Tanggal</td>
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td><input name="nama" type="text" id="nama" value="" required></td>
    <td>Jam  </td>
    <td><input name="jam" type="text" id="jam" size="8" value="<?php echo "".date('H:i') ;?>"></td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td>Tempat lahir *</td>
    <td><input name="t4_lahir" type="text" id="t4_lahir" value="" required></td>
    <td>Jenis Kelamin *</td>
    <td>
  ...
  <tr bgcolor="#FFFFFF">
    <td>Tanggal Lahir *</td>
    <td><input name="tgl_lahir" type="text" id="tgl_lahir" size="10" value="" required>
  ...
  <tr bgcolor="#FFFFFF">
    <td>Alamat *</td>
    <td><input name="alamat" type="text" id="alamat" value=""  required></td>
    <td>Nomor HP/WA aktif *</td>
    <td><input name="telp_rumah" type="text" id="telp_rumah" value=""  required></td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td>RT/RT</td>
