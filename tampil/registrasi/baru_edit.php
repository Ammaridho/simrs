...
<tr bgcolor="#CCCCCC"> 
    <td colspan="4"><strong>DATA PASIEN <?php echo $data['prn']; ?></strong></td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td>PRN</td>
    <td>
...
<?php 
$prn = $_GET['prn'];
$sql1 = "SELECT * FROM data_pasien WHERE prn='$prn'";
...
<tr bgcolor="#CCCCCC">
  ...
  <tr bgcolor="#FFFFFF">
    <td>Alamat</td>
    <td><input name="alamat" type="text" id="alamat" value="<?php echo $data1['alamat']; ?>"></td>
    <td>Nomor HP/WA Aktif</td>
    <td><input name="telp_rumah" type="text" id="telp_rumah" value="<?php echo $data1['telp_rumah']; ?>"></td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td>RT/RT</td>
    <td><input name="rt" type="text" id="rt" value="<?php echo $data1['rt']; ?>"></td>
    <td>Telpon Kantor</td>
    <td><input name="telp_kantor" type="text" id="telp_kantor" value="<?php echo $data1['telp_kantor']; ?>"></td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td>Desa/Kelurahan</td>
    <td><input name="kel" type="text" id="kel" value="<?php echo $data1['kel']; ?>"></td>
    <td>Handphone 1 </td>
    <td><input name="hp1" type="text" id="hp1" value="<?php echo $data1['hp1']; ?>"></td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td>Kecamatan</td>
    <td><input name="kec" type="text" id="kec" value="<?php echo $data1['kec']; ?>"></td>
    <td>Handphone 2 </td>
    <td><input name="hp2" type="text" id="hp2" value="<?php echo $data1['hp2']; ?>"></td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td>Kota/Kabupaten</td>
    <td><input name="kab" type="text" id="kab" value="<?php echo $data1['kab']; ?>"></td>
    <td>Handphone 3 </td>
    <td><input name="hp3" type="text" id="hp3" value="<?php echo $data1['hp3']; ?>"></td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td>Provinsi</td>
    <td><input name="prov" type="text" id="prov" value="<?php echo $data1['prov']; ?>"></td>
    <td  colspan="2">&nbsp;</td>
    </tr>
<tr bgcolor="#CCCCCC">
  ...
  <tr bgcolor="#FFFFFF">
    <td>Nama</td>
    <td><input name="nama_pj" type="text" id="nama_pj" value="<?php echo $data1['nama_pj']; ?>"></td>
    <td>Telpon Rumah</td>
    <td><input name="telp_rumah_pj" type="text" id="telp_rumah_pj" value="<?php echo $data1['telp_rumah_pj']; ?>"></td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td>Alamat</td>
    <td><input name="alamat_pj" type="text" id="alamat_pj" value="<?php echo $data1['alamat_pj']; ?>"></td>
    <td>Telpon Kantor</td>
    <td><input name="telp_kantor_pj" type="text" id="telp_kantor_pj" value="<?php echo $data1['telp_kantor_pj']; ?>"></td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td>Hubungan</td>
    <td><input name="hub" type="text" id="hub" value="<?php echo $data1['hub']; ?>"></td>
    <td>Handphone</td>
    <td><input name="hp_pj" type="text" id="hp_pj" value="<?php echo $data1['hp_pj']; ?>"></td>
  </tr>
<tr>
    <td bgcolor="#FFFFFF" colspan="4">
    <input type="submit" name="submit" value="Update" onClick="form1.action='baru_edit_sim.php?prn=<?php echo $data1['prn'];?>'; return true;">
    <input type="submit" name="Submit" value="Daftar Rajal">
	<span align="right"><input type="submit" name="submit" value="Daftar Ranap" onClick="form1.action='reg_ri.php?prn=<?php echo $data1['prn'];?>'; return true;"></span>
    </td>
  </tr>
   </form>
</table>
