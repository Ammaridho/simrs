...
$ruang = mysqli_query($koneksi, "SELECT * FROM ruang GROUP BY ruang");
while($p=mysqli_fetch_array($ruang)){
...
?>
    ...
    <td width="25%"><select name="kamar" id="kamar">
      ...
      <?php
//mengambil nama-nama klinik yang ada di database
$kamar = mysqli_query($koneksi, "SELECT * FROM ruang");
...
?>
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td><select name="kelas" id="kelas">
      <?php
//mengambil nama-nama klinik yang ada di database
$kelas = mysqli_query("SELECT * FROM ruang GROUP BY kelas");
